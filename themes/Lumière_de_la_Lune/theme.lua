...
theme.bg_normal = "#282D50"
theme.bg_focus = "#7788BB"
theme.bg_urgent = "#ff0000"
theme.bg_minimize = "#628CC0"
theme.bg_overlay_opacity = "FF" -- "C0"

theme.fg_normal = "#C8C8DC"
theme.fg_focus = "#ffffff"
theme.fg_urgent = "#000000"
theme.fg_minimize = "#78788C"

-- space between aligned/snapped windows
theme.useless_gap = 0

theme.border_width = 1
theme.border_normal = "#464664"
theme.border_focus = "#5A78C8"
...
theme.tooltip_border_color = "#B0B6D5"
...
theme.progressbar_bg = "#191E3C"..theme.bg_overlay_opacity
...
--theme.menu_bg_focus = theme.progressbar_bg.."80"
--theme.menu_shape = function(c, w, h) shape.rounded_rect(c, w, h, 3) end
...
theme.notification_shape = function(c, w, h) shape.rounded_rect(c, w, h, 12) end
	...
	theme.notification_bg_critical = theme.bg_urgent--.."80"
...
theme.wallpaper = {theme.path.."/Anniversary_1st_1920_1080_dark.png", theme.path.."/background.png"}
